...
/*		for(int i=0;i<dateList.size();i++){
		...
		List<String> normalCodeList = CodeUtil.getIHCodeList();
		List<String> normalCodeList2 = CodeUtil.get50CodeList();
		normalCodeList.addAll(normalCodeList2);
