 ...
 *
 */
public class DownloadOneYear50part {
...
/*		for(int i=0;i<dateList.size();i++){
		...
		List<String> normalCodeListAll = CodeUtil.get50CodeList();
		List<String> normalCodeList = CodeUtil.getMoreCodeList(); //normalCodeListAll.subList(42, normalCodeListAll.size());
