...
import tdb.dao.akka.InsertAkka;
...
public class CreateInsertData {
	...
	static ActorRef akkaActor0;
	static ActorRef akkaActor1;
	static ActorRef akkaActor2;
	static ActorRef akkaActor3;
	static ActorRef akkaActor4;
	static ActorRef akkaActor5;
	static ActorRef akkaActor6;
	static ActorRef akkaActor7;
	
	static{
		 _system = ActorSystem.create("TestAkka");
	     akkaActor0 = _system.actorOf(new Props(InsertAkka.class), "akka1");
		 akkaActor1 = _system.actorOf(new Props(InsertAkka.class), "akka2");
		 akkaActor2 = _system.actorOf(new Props(InsertAkka.class), "akka3");
		 akkaActor3 = _system.actorOf(new Props(InsertAkka.class), "akka4");
		 akkaActor4 = _system.actorOf(new Props(InsertAkka.class), "akka5");
		 akkaActor5 = _system.actorOf(new Props(InsertAkka.class), "akka6");
		 akkaActor6 = _system.actorOf(new Props(InsertAkka.class), "akka7");
		 akkaActor7 = _system.actorOf(new Props(InsertAkka.class), "akka8");
	}
	...
	public static void insertDataByString(String code ,List<String> ticksList){
		...
		for(int i=0;i<ticksList.size();i++){
			...
			int actorNum = i % 8;  //创建actor存数据
			switch (actorNum) {
			case 0:
				akkaActor0.tell(insertSQL);
				break;
			case 1:
				akkaActor1.tell(insertSQL);
				break;
			case 2:
				akkaActor2.tell(insertSQL);
				break;
			case 3:
				akkaActor3.tell(insertSQL);
				break;
			case 4:
				akkaActor4.tell(insertSQL);
				break;
			case 5:
				akkaActor6.tell(insertSQL);
				break;
			case 6:
				akkaActor6.tell(insertSQL);
				break;
			case 7:
				akkaActor7.tell(insertSQL);
				break;

			default:
				System.out.println("被8除余数有问题！");
				akkaActor0.tell(insertSQL);
				break;
			}
