 ...
 *
 */
public class DownloadOnecodeBetweenDay3 {
...
/*		for(int i=0;i<dateList.size();i++){
		...
		normalCodeList.add("cu.SHF");
		normalCodeList.add("ni.SHF");
		normalCodeList.add("ru.SHF");
		normalCodeList.add("rb.SHF");
